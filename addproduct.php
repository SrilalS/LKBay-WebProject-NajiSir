...
<head>
    ...
    <title>Add Product - LKBay.lk</title>
            ...
            <div class="container">
                <div class="block-heading">
                    ...
                    <?php
                        $E = $_SESSION["E"];
                        echo <<<HD
                                <h4 hidden id="eml" >$E</h3>
                            HD;
                    ?>
                </div>

                <form onsubmit="return false" id="Mforum">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control item" type="number" id="price" required="">
                    </div>

                    <div class="form-group">
                        <label for="details">Description</label>
                        <input class="form-control item" type="desc" id="desc" required="">
                    </div>

                    <div class="form-group">
                        <label for="email">Company</label>
                        <input class="form-control item" type="text" id="comp" inputmode="text" required="">
                    </div>

                    <div class="form-group">
                        <label for="email">Product Image (400px x 400px is Recommended)</label>
                        <input class="form-control item" accept="image/*" type="file" id="file" required="">
                    </div>
